...
|聚合渠道版本号:| v3.3.4 | v4.310.1180 | v3.4.0.0 | v5.96| v3.3.5.3| v3.4.4
|SDK ID 标识:| "1" |  "2"|  "3"|  "4"|  "5"| -
...
SDK引入主要有两种方式，一是通过线上gradle依赖引入，二是通过本地aar包引入；如果gradle引入不成功可以联系我们提供本地aar来引入，引入参考如下：
...
dependencies {
    ...
    //必须，MSA Android10以上设备唯一标识 OAID SDK 引入，详见 3.OAID支持
    implementation 'com.advsdk:advance_oaid:1.0.25'
    //mercury SDK 平台广告渠道包引入
