...
advancelib_3.2.1.aar(聚合SDK包)

mercurysdk_3.1.5.aar  （mercurySDK 集成后apk增加约500k）
...
repositories {
    ...
    implementation(name: 'advancelib_3.2.1', ext: 'aar')
    ...
    implementation 'com.mercury:mercurysdk:3.1.5'
    //mercury 引入方式二：本地aar引入
    implementation(name: 'mercurysdk_3.1.5', ext: 'aar')
