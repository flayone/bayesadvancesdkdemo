...
- 激励视频(RewardVideo)：广点通，穿山甲,Mercury
...
advancelib_3.0.2.aar(聚合SDK包)

mercurysdk_3.0.4.aar

GDTSDK.union.4.80.950.aar

open_ad_sdk.aar  (穿山甲v2.8.0.1)
