...
<font size = "4">**版本号：v3.4.3.1**


## 1.集成须知

1. Advance 聚合SDK示例Demo	:
[点击下载最新Demo](http://www.bayescom.com/download/sdk/AdvanceSDK_Android_3.4.3.1.zip)
...
|当前支持的版本号:| v3.3.4 |  v4.310.1180 | v3.4.0.0 |  内置v5.96| 内置v3.3.5.3| v3.4.3.1
|SDK ID 标识:| "1" |  "2"|  "3"|  "4"|  "5"| -
...
SDK引入主要有两种方式，一是通过线上gradle依赖引入，二是通过本地aar包引入；聚合中两种引入方式均存在，以下为各个SDK的作用及引入方式：
...
dependencies {
    ...
    //Advance聚合SDK 引入
    implementation 'com.advsdk:advance:3.4.3.1'

    //mercury SDK 引入
    implementation 'com.mercury:mercurysdk:3.3.4'
    //穿山甲SDK 引入
