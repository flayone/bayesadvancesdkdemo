...
repositories {
    ...
    implementation(name: 'advancelib_3.2.4', ext: 'aar')
    implementation(name: 'open_ad_sdk', ext: 'aar')
    implementation(name: 'GDTSDK.unionNormal.4.174.1044', ext: 'aar')
    implementation(name: 'msa_mdid_1.0.13', ext: 'aar')
    
    //mercury 引入方式一：jcenter 
    implementation 'com.mercury:mercurysdk:3.2.1'
    //mercury 引入方式二：本地aar引入
    implementation(name: 'mercurysdk_3.2.1', ext: 'aar')
    ...
    public void onCreate() {
        ...
        //聚合SDK初始化
         AdvanceConfig.getInstance()
                       ...
                       .setAppName("你在穿山甲后台申请的应用名称")
                       .setGdtMediaId("你在广点通后台申请的MediaId")
                       .setMercuryMediaId("你在Mercury后台申请的MediaId")
                       .setMercuryMediaKey("你在Mercury后台申请的MediaKey")
                       .initSDKs(this);       
